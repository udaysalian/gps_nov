    ...
    describe('Contract Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/contracts';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Contract', () => {
                service.create(new Contract(null)).subscribe(received => {
            ...
            it('should update a Contract', () => {
                service.update(new Contract(123)).subscribe(received => {
