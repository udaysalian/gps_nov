    ...
    describe('BusinessUnit Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a BusinessUnit', () => {
                service.create(new BusinessUnit(null)).subscribe(received => {
            ...
            it('should update a BusinessUnit', () => {
                service.update(new BusinessUnit(123)).subscribe(received => {
            ...
            it('should return a BusinessUnit', () => {
            ...
            it('should return a list of BusinessUnit', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new BusinessUnit(123)]);
            });
